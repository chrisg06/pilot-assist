...
<template>
  ...
  <main>
    <div
      class="min-w-full px-6 pb-6 pt-4 mt-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700"
    >
      <h1>
        <h5 class="mb-4 text-4xl font-bold flex justify-center text-gray-900 dark:text-white">
          Weather Finder
        </h5>
      </h1>

      <form class="flex flex-col" @submit.enter.prevent >
        ...
        <ul v-if="!loading" class="my-4 space-y-3">
          ...
          <li>
            <div class="grid grid-cols-2 md:flex-row gap-8 pb-5">
              <div class="flex-grow border border-blue-300 overflow-hidden shadow-md rounded-lg">
                <div class="px-4 py-5 sm:p-6 mx-auto">
            ...
            <div class="grid grid-cols-2 md:flex-row gap-8">
              <div class="flex-grow border border-blue-300 overflow-hidden shadow-md rounded-lg">
                <div class="px-4 py-5 sm:p-6 mx-auto">
            ...
            <div class="grid grid-cols-2 md:flex-row gap-8">
              <div class="flex-grow border border-blue-300 overflow-hidden shadow-md rounded-lg">
                <div class="px-4 py-5 sm:p-6 mx-auto">
                  ...
                  <p class="mt-1 text-xl font-semibold text-gray-900" v-for="weather in wx.wx">{{ weather }}</p>
                </div>
              </div>
              <div class="flex-grow border border-blue-300 overflow-hidden shadow-md rounded-lg">
                <div class="px-4 py-5 sm:p-6 mx-auto">
                  ...
                  <div class="flex justify-start">
                    <p class="mt-1 text-xl font-semibold text-gray-900 mr-3" v-for="cld in wx.cld">{{ cld }}</p>
                  </div>
